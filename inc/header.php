...
<head>
    ...
    <style>
        ...
        a{color:#3399FF;}
        .headeroption{background:#3399ff url("") no-repeat scroll 56px 18px; height:80px; overflow:hidden; padding-left:160px;}
...
<body>
    ...
    <div class="content">
        <section class="subject">
          <p>CRUD <span style="float:right">
          <a href="index.php">Create Student</a> ||
          <a href="teacher.php">Create Teacher</a>
            </span></p>
        </section>